...
DEFAULT_MAX_QUEUE_SIZE = int(os.getenv("DEFAULT_MAX_QUEUE_SIZE", 1000))  # Prevents OOM for batching integrations
DEFAULT_QUEUE_OVERFLOW_STRATEGY = os.getenv("DEFAULT_QUEUE_OVERFLOW_STRATEGY", "force_flush")  # Strategy when queue is full
